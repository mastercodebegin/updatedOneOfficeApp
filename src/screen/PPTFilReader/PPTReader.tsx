...
`;
    ...
    const pptUrl = "https://example.com/sample.pptx"; // Replace with your PPT file URL
    const googleDocsUrl = `https://docs.google.com/gview?embedded=true&url=${uri}`;
...
<CustomSpinner isLoading={isLoading}/>
                    ...
                    <View style={{flex:1}}>
            <WebView source={{ uri: googleDocsUrl }} style={{ flex: 1 }} />
        </View>
        </View>
    );
}
...
export default React.memo(PPTReader);